...
@section('main-container')
	...
	<!-- end product section -->
        ...
        <div class="more-products mb-150" style="margin-top: 70px">
        <div class="container">
            <div class="row">
                    ...
                    @if ($count < 3)
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="single-product-item">
                                ...
                                <a href="{{ url("/single-product/$relatedProduct->pid") }}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to
                                    Cart</a>
                            </div>
                        </div>
                        @php $count++; @endphp
    	...
    	<div class="container">
        	<div class="row clearfix">
                	...
                	<div class="image">
                    	<div class="price-box">
                        	<div class="inner-price">
                                <span class="price">
                                    <strong>Fresh</strong> <br> hand picked
                                </span>
                            </div>
                        </div>
                ...
                <div class="content-column col-lg-6">
                	...
                	<a href="{{ url("/single-product/1") }}" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
                </div>
            </div>
        </div>
    </section>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							...
							<a href="{{url('/single-news')}}single-news.html" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
